...
# the plane a window has a use for: the scramble laid on the cube and
# the stop ending every attempt are said here, by the one side that
# knows them, whichever cube is connected. A complete topic name
